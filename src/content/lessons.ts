...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    level: "advanced",
    estimatedMinutes: 50,
    targetJourneys: ["engineer", "founder", "adopter"],
  ...
  },
  {
    ...
    level: "beginner",
    estimatedMinutes: 40,
    targetJourneys: ["creator", "explorer"],
    prerequisites: ["structure-of-good-prompts"],
    learningGoals: [
  ...
  },
  {
    ...
    level: "intermediate",
    estimatedMinutes: 45,
    targetJourneys: ["adopter", "founder", "practitioner"],
  ...
  // Phase 0 — AI 학습 환경 세팅
  {
    ...
    level: "beginner",
    estimatedMinutes: 20,
    targetJourneys: ["adopter", "creator", "explorer", "founder"],
    prerequisites: [],
    learningGoals: [
  ...
  },
  {
    ...
    level: "beginner",
    estimatedMinutes: 30,
    targetJourneys: ["adopter", "creator", "explorer", "engineer", "practitioner"],
  ...
  },
  {
    ...
    summary: "AI Builder School 실습에 필요한 도구 계정(GitHub, Claude/OpenAI API, Codex CLI)을 설치하고, 각 도구의 무료/유료 경계와 API 비용 구조를 이해합니다. 실수로 과금되는 상황을 예방하는 비용 알림 설정까지 완료합니다.",
    level: "beginner",
    estimatedMinutes: 35,
    targetJourneys: ["adopter", "creator", "explorer", "founder", "engineer", "practitioner"],
    prerequisites: ["terminal-first-day"],
    learningGoals: [
      "AI Builder School 실습에 필요한 계정을 모두 생성하고 확인한다",
      "각 도구의 무료/유료 경계를 이해한다",
      "API 키를 안전하게 저장하는 방법(.env 파일)을 익힌다",
      "API 비용 알림을 설정해 예상치 못한 과금을 방지한다",
    ],
    problemScenario:
    ...
    mission:
      "아래 계정을 순서대로 생성하고 설정하세요. 35분 안에 완성하는 것을 목표로 합니다.\n\n**작업 1 — 필수 계정 생성 (10분)**\n- [ ] GitHub 계정 (github.com)\n- [ ] Anthropic 계정 (console.anthropic.com) — Claude API용\n- [ ] OpenAI 계정 (platform.openai.com) — 선택사항\n\n**작업 2 — API 키 발급 + 안전 저장 (10분)**\n```bash\n# my-ai-builder-lab 폴더에서\ntouch .env\ntouch .gitignore\necho '.env' >> .gitignore\n```\n`.env` 파일에 입력:\n```\nANTHROPIC_API_KEY=sk-ant-...\n```\n\n**작업 3 — 비용 알림 설정 (5분)**\n- Anthropic Console → Settings → Limits → Monthly spend limit을 $5 또는 $10으로 설정\n\n**작업 4 — 도구별 무료/유료 경계 정리 (10분)**\n- AI에게 '각 도구의 무료 티어 한계와 유료 전환 시점을 표로 정리해줘'라고 요청하고 메모",
    codexNote:
    ...
    buildSteps: [
      "GitHub / Anthropic / OpenAI 계정 생성",
      "my-ai-builder-lab 폴더에 .env + .gitignore 파일 생성",
      ".gitignore에 .env 추가 확인",
      "Anthropic Console에서 monthly spend limit 설정",
      "도구별 무료/유료 경계 AI와 정리",
    ],
    verificationChecklist: [
      "GitHub 계정이 있고 로그인이 된 상태인가",
      "Anthropic API 키가 .env 파일에 저장됐는가",
      ".gitignore 파일에 .env가 포함됐는가",
      "Anthropic Console에서 spending limit이 설정됐는가",
      "`git status`를 쳤을 때 .env 파일이 tracked 상태가 아닌가",
    ],
    deliverable: {
      title: "환경 설정 완료 상태",
      description: ".env + .gitignore가 있는 my-ai-builder-lab 폴더 + Anthropic spending limit 설정 스크린샷 (선택). 도구별 무료/유료 경계 메모.",
      format: "로컬 파일 + 메모",
    },
    reflectionQuestions: [
      "API 키를 .env에 저장하고 .gitignore에 추가하는 이유를 설명할 수 있나요?",
      "spending limit을 설정하지 않으면 어떤 일이 생길 수 있나요?",
      "무료로 쓸 수 있는 것과 유료가 필요한 것을 구분했나요?",
    ],
    extensionIdeas: [
  ...
  // ─── Phase 11 — AI Product & Monetization ───────────────────────────────
  {
    ...
    level: "intermediate",
    estimatedMinutes: 40,
    targetJourneys: ["founder", "adopter", "creator"],
  ...
  },
  {
    ...
    level: "intermediate",
    estimatedMinutes: 45,
    targetJourneys: ["founder", "creator", "adopter"],
  ...
  },
  {
    ...
    level: "intermediate",
    estimatedMinutes: 45,
    targetJourneys: ["founder", "adopter"],
  ...
  },
  {
    ...
    level: "beginner",
    estimatedMinutes: 45,
    targetJourneys: ["founder", "creator", "adopter", "explorer"],
  ...
  },
  {
    ...
    level: "intermediate",
    estimatedMinutes: 45,
    targetJourneys: ["engineer", "founder", "creator", "adopter"],
