...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    conceptDepth: {
      ...
      practicalExplanation: "환각은 버그가 아니라 LLM의 기본 성질이에요. '모른다'를 잘 못 하니, 사실 주장마다 출처를 요구하고 교차 검증하는 습관으로 통제합니다.",
      implementationNotes: "사실 주장을 추출해 원문과 대조하고, 출처 없는 문장은 표시하거나 제거합니다. '근거 없으면 모른다고 답하라'를 시스템 프롬프트에 명시해요.",
      deeperTheory: "LLM은 다음 토큰의 그럴듯함을 최적화할 뿐 참·거짓을 판별하지 않아요. 그래서 유창함과 정확함이 분리됩니다 — 검증이 사람 몫인 이유예요.",
    },
  ...
  },
  {
    ...
    neededWhen: "어디까지 AI에 맡기고 어디서 사람이 봐야 할지 선이 안 그어질 때. 발행·제출 전에 빠르게 신뢰도를 점검할 루틴이 필요할 때.",
    conceptDepth: {
      explainLikeTwelve: "자동 채점기를 믿되, 점수가 인생을 바꾸는 시험은 사람이 한 번 더 봐요. 위험이 큰 곳에만 사람 눈을 둡니다.",
      practicalExplanation: "모든 출력을 검토하면 AI 쓰는 의미가 없어요. 되돌리기 어렵거나 영향이 큰 지점(외부 발송·결제·공개)에만 사람 게이트를 둡니다.",
      implementationNotes: "사실·출처·가정·범위·편향 5축을 5분 안에 점검하는 루틴(FOSCB)으로 신뢰 결정을 체크리스트화합니다.",
      deeperTheory: "AI 품질은 모델 성능이 아니라 검토 지점 설계에서 갈려요. 사람을 빼는 게 아니라 가장 효과적인 한 곳에 배치하는 문제입니다.",
    },
  ...
  },
  {
    ...
    conceptDepth: {
      ...
      implementationNotes: "맵-리듀스 요약, 청킹 후 관련 조각만 주입(RAG), 계층 요약으로 입력을 작업 모양에 맞춰요.",
      deeperTheory: "어텐션은 입력이 길수록 희석되고 중간이 약해져요('Lost in the Middle'). 입력 설계가 출력 품질을 좌우하는 구조적 이유입니다.",
    },
  ...
  },
  {
    ...
    neededWhen: "좋은 프롬프트를 어떤 형식으로 모아둘지 모를 때. 매번 처음부터 쓰지 않고 검증된 프롬프트를 재사용하고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "자료는 잔뜩 모았는데 핵심만 추려내기 어려울 때. 요약에 출처를 붙여 근거 있는 리서치로 만들고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "코딩 에이전트 환경 설정에서 막혀 시작도 못 했을 때. 권한·규약·비밀키를 어떤 순서로 깔지 막막할 때.",
  ...
  },
  {
    ...
    neededWhen: "에이전트가 코드베이스 맥락을 몰라 엉뚱한 파일을 고치거나 과하게 바꿀 때. 팀 협업 코딩·레거시 리팩터에서 첫 시도가 자꾸 헛나갈 때.",
  ...
  },
  {
    ...
    neededWhen: "범위가 자꾸 커져 마감 안에 못 끝낼 것 같을 때. 코드를 짜기 전에 AI와 구현 계획부터 좁히고 싶을 때.",
    summary:
  ...
  },
  {
    ...
    neededWhen: "코드를 건드리면 뭐가 깨질지 몰라 손을 못 댈 때. AI에게 구현을 맡기기 전에 안전망부터 깔고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "버그를 재현하는 것부터 막막할 때. 에이전트에게 고쳐달라기 전에 문제를 또렷이 좁히고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "AI 응답 형식이 들쭉날쭉해 앱 코드가 깨질 때. JSON을 검증 없이 믿고 썼다가 터질 때.",
  ...
  },
  {
    ...
    conceptDepth: {
      explainLikeTwelve: "단어를 지도 위 좌표로 바꾸는 거예요. 뜻이 비슷하면 가까이, 다르면 멀리 찍혀요. '강아지'와 '반려견'은 옆동네예요.",
      practicalExplanation: "키워드가 달라도 의미가 같으면 찾아내요. 검색·추천·중복 탐지의 바탕이 되는 '의미 거리' 계산입니다.",
      implementationNotes: "임베딩 모델로 텍스트를 벡터화해 저장하고, 질의도 벡터로 바꿔 코사인 유사도로 가장 가까운 것을 찾습니다.",
      deeperTheory: "비슷한 맥락에서 함께 등장하는 표현은 학습 과정에서 벡터 공간상 가까워져요. 의미가 기하학적 거리로 표현되는 게 임베딩의 핵심입니다.",
    },
  ...
  },
  {
    ...
    neededWhen: "RAG가 관련 문서를 아예 못 찾거나 엉뚱한 걸 가져올 때. 파일 전체를 매번 넣기엔 너무 커졌을 때.",
  ...
  },
  {
    ...
    conceptDepth: {
      explainLikeTwelve: "AI는 말은 잘하지만 손이 없어요. 도구 목록을 쥐여주면 '이 도구를 이렇게 써줘'라고 주문서를 써냅니다 — 실제로 쓰는 건 우리 코드예요.",
      practicalExplanation: "날씨·DB·결제 같은 실제 작업은 모델이 직접 못 해요. 함수 스키마를 주면 호출할 함수와 인자를 JSON으로 정해주고, 실행은 앱이 합니다.",
      implementationNotes: "도구 스키마(이름·설명·파라미터)를 모델에 전달하고, 반환된 tool_call로 실제 함수를 실행한 뒤 결과를 다시 모델에 돌려줍니다.",
      deeperTheory: "모델은 텍스트 생성기일 뿐이라 행동이 구조화된 호출 요청으로 분리돼요. 생성과 실행을 나누는 게 안전성과 확장성의 핵심입니다.",
    },
  ...
  },
  {
    ...
    conceptDepth: {
      explainLikeTwelve: "미로에서 한 걸음 가고, 둘러보고, 다음 걸음을 정하는 것과 같아요. 한 번에 못 푸는 일을 작은 반복으로 풀어요.",
      practicalExplanation: "도구 호출 한 번으로 안 끝나는 작업은 루프가 필요해요. 생각→행동→관찰→다시 생각을 목표 달성까지 반복합니다(ReAct).",
      implementationNotes: "관찰을 컨텍스트에 누적하며 다음 행동을 결정하는 루프. 종료 조건·최대 반복·도구 결과 주입을 설계합니다.",
      deeperTheory: "단발 생성으로 못 푸는 문제를 상태를 누적하는 반복으로 분해해요. 다만 맥락이 길어질수록 길을 잃기 쉬워, 루프 설계가 곧 신뢰성입니다.",
    },
  ...
  },
  {
    ...
    neededWhen: "에이전트에게 도구 권한을 어디까지 줘야 할지 불안할 때. 파일 삭제·외부 호출 같은 위험한 작업에 울타리가 필요할 때.",
  ...
  },
  {
    ...
    neededWhen: "봇이 '이전 지시를 무시하고…' 같은 공격 문장에 넘어갈 때. 외부 입력을 그대로 모델에 넣고 있을 때.",
    conceptDepth: {
      explainLikeTwelve: "택배 상자 안에 '주인에게 금고를 열어주라'는 쪽지가 들어 있는 셈이에요. 배달물(데이터)과 집주인 지시(명령)를 섞으면 위험해요.",
      practicalExplanation: "외부 문서·웹페이지·사용자 입력에 '이전 지시 무시하고…'가 숨어 있을 수 있어요. 데이터와 지시를 분리하고 권한을 최소화해 방어합니다.",
      implementationNotes: "입력을 명확히 구획(델리미터·역할 분리)하고, 민감 도구는 사람 승인 게이트를 두며, 출력도 검증합니다. 신뢰 경계를 코드로 강제해요.",
      deeperTheory: "LLM은 지시와 데이터를 같은 토큰 스트림으로 받아 구분이 본질적으로 약해요. 그래서 방어는 모델이 아니라 권한·구조 설계에서 나옵니다.",
    },
  ...
  },
  {
    ...
    neededWhen: "토큰 비용이 예측이 안 돼 불안할 때. 사용자가 늘면 요금이 얼마나 뛸지 미리 가늠하고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "긴 글을 쇼츠 길이로 줄이면 맥락이 깨질 때. 자산 하나를 여러 채널 포맷으로 톤을 지키며 재가공하고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "한 장은 잘 나오는데 다음 장은 톤이 어긋나 채널 비주얼이 누더기처럼 흩어질 때. 이미지 묶음의 스타일을 한 톤으로 고정하고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "여러 시안 중 어떤 게 더 나은지 감으로는 판단이 안 설 때. 썸네일·제목을 데이터로 고르고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "오늘 뭘 올릴지 매일 백지에서 고민할 때. 매장·브랜드 콘텐츠를 한 달치 미리 굴리고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "프롬프트를 바꿨더니 품질이 좋아졌는지 나빠졌는지 숫자로 안 보일 때. 출력을 관측하고 회귀를 잡을 루프가 필요할 때.",
  ...
  },
  {
    ...
    neededWhen: "팀 AI 사용 가이드라인을 어떤 뼈대로 써야 할지 막막할 때. '그걸 AI가 썼다고요?' 같은 사고를 미리 막고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "민감정보를 AI에 넣어도 되는지 헷갈릴 때. 시작 전에 나만의(또는 팀의) AI 사용 기준선을 그어두고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "AI 호출 비용이 무서워 제품 가격을 못 정할 때. 원가와 마진을 잡아 유료 전환을 설계하고 싶을 때.",
  ...
  },
  {
    ...
    neededWhen: "아이디어가 데모에서 멈추고 제품으로 안 넘어갈 때. 한 주 단위로 빌드를 끊어 끝까지 굴리는 리듬이 필요할 때.",
  ...
  },
  {
    ...
    conceptDepth: {
      explainLikeTwelve: "요리할 때 칼질은 맡겨도 간은 직접 봐요. 맡길 일과 내가 할 일을 먼저 가르는 거예요.",
      practicalExplanation: "AI 활용의 첫 기술은 좋은 프롬프트가 아니라 '이 일을 맡길까'의 판단이에요. 반복적·검증 쉬운 일은 AI, 책임·판단이 큰 일은 사람.",
      implementationNotes: "작업을 영향도×검증난도로 분류해 위임 기준표를 만들고, 맡긴 일에도 검토 지점을 한 곳 남깁니다.",
      deeperTheory: "AI는 비용을 낮추지만 책임을 대신 지지 않아요. 그래서 위임은 능력 문제가 아니라 되돌릴 수 있는가의 위험 배분 문제입니다.",
    },
    summary:
  ...
  },
  {
    ...
    neededWhen: "발행·전달 전 AI 출력 품질을 어떻게 점검할지 모를 때. 첫 답을 그대로 쓰지 않고 한 번 더 다듬고 싶을 때.",
    conceptDepth: {
      explainLikeTwelve: "글쓰기 숙제를 채점 기준표로 매기는 거예요. '느낌'이 아니라 항목별 점수로 보면 어디를 고칠지 분명해져요.",
      practicalExplanation: "첫 답을 그대로 쓰지 않고, 채점 루브릭으로 약한 축을 찾아 다시 요청해요. 좋아졌는지를 같은 기준으로 비교합니다.",
      implementationNotes: "평가 항목(정확성·완결성·톤 등)을 점수화한 루브릭을 만들고, 골든 셋에 반복 적용해 프롬프트 변경 전후를 비교합니다.",
      deeperTheory: "측정 없이는 개선도 회귀 감지도 불가능해요. evals는 느낌을 재현 가능한 숫자로 바꿔 AI 품질을 공학으로 만드는 토대입니다.",
    },
    summary:
  ...
  },
  {
    ...
    neededWhen: "특정 사용자만 들어오게 막아야 할 때. 사용자별 기록·비용·권한을 나눠야 할 때.",
    summary:
  ...
  },
  {
    ...
    neededWhen: "에이전트가 멈추거나 같은 단계를 맴돌 때. 자율 루프가 왜 무너지는지 패턴으로 미리 짚고 싶을 때.",
    summary:
  ...
  },
  {
    ...
    neededWhen: "배포는 했는데 아무도 안 올 때. 첫 사용자 5명을 어디서 어떻게 데려올지 막막할 때.",
    summary:
