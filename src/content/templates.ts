...
- [ ] 비용 급증 시 알림이 오는가`,
  ...
  {
    id: "tpl-ai-strength-self-check",
    slug: "ai-strength-self-check",
    title: "AI 강약 자가진단 v1 — Stage 1 시작점 + 5주 후 비교 양식",
    kind: "checklist",
    targetJourneys: ["starter", "practitioner", "creator", "founder", "engineer", "ai-native"],
    summary: "Stage 1 들어가기 전 본인 위치 6 항목 자가진단. 점수로 가까운 여정 추정 + 5주 뒤 같은 표를 다시 채워 변화 측정. Stage 1의 통합 산출물 \"AI 강약 판단지 v1\"의 시작점.",
    body: `# AI 강약 판단지 v1

> Stage 1 들어가기 전에 한 번, Stage 1 끝난 뒤 한 번, 그리고 **5주 후에 한 번 더**.
> 같은 표를 세 번 채워 변화를 한 페이지에 본다.

## 1. 자가진단 (6 항목)

각 항목에 ✅ (자주 한다) · △ (가끔 / 들어봤다) · ❌ (안 한다 / 모른다)로 표시.

| # | 항목 | 오늘 | 5주 후 | 비고 |
|---|---|---|---|---|
| 1 | AI 챗봇(ChatGPT / Claude / Gemini 등)을 매일 쓴다 | | | |
| 2 | AI가 한 답을 한 번이라도 의심해본 적이 있다 | | | |
| 3 | 터미널을 열어 명령 한 줄이라도 쳐본 적이 있다 | | | |
| 4 | git 또는 GitHub를 한 번이라도 써본 적이 있다 | | | |
| 5 | AI를 쓸 때 토큰·맥락·비용 중 한 가지라도 의식한다 | | | |
| 6 | 어떤 일을 AI에 맡기고 어떤 일은 직접 할지 — 본인 기준이 있다 | | | |
...
| 점수 | 가까운 여정 | 추천 학습 강도 |
|---|---|---|
| 0~1.5 | 🌱 Starter | 13개 다, 천천히 |
| 2~3 | Practitioner 또는 Creator | 6~9개 골라서 |
| 3.5~4.5 | Founder 또는 Engineer | 4~6개, 약한 곳만 |
| 5~6 | 🌳 AI Native | 복습용 + 다음 단계 집중 |

- 오늘의 점수: **___ 점** → 가까운 여정: **___**
- 본인이 가고 싶은 여정 (선택): **___**

## 3. 목표 한 문장

> "Stage 1이 끝났을 때 (___)을(를) 할 수 있게 되고 싶다."

## 4. 5주 후 약속

- 오늘 날짜: **___**
- 5주 후 = **___** (위 표의 "5주 후" 칸을 그날 채운다)

## 5. Stage 1 끝난 뒤 추가 — 위임 기준 (1C 레슨에서)

> Stage 1의 1C "함께 일하는 판단" 레슨을 마치고 여기에 본인 기준을 추가.
...
**경계가 모호해서 매번 판단해야 할 일**
-
-`,
    tags: ["foundation", "self-diagnosis", "stage-1-deliverable", "starting-point"],
  },
];
