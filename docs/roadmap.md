...
**✅ 1차(2026-06-07)** — Gemini BYO 키(`lib/gemini.ts`·`useApiKey`·`PromptPlayground`), `Lesson.playgroundPrompt`로 레슨에 삽입(개념 깊이 아코디언 다음 — "개념 → 즉시 실습"). `structure-of-good-prompts`에 첫 적용. 확대·Concept 노드 연동은 다음.
