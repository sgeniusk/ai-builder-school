...
### 2순위 — Stage 재구조(8→6) + 레슨 통합·심화 · 스펙 2 v2
페르소나 수렴/발산 검토에서 8 Stage를 6 Stage로 통합하기로 결정 (S2+S3, S7+S8 통합 + 빌더 분기점 명시). 84 → 61 레슨, 그중 17개는 신규 통합 슬러그. AI 문체 교정. 84개 전수 첨삭표 포함.
- 스펙 v2 — `docs/specs/2026-05-22-six-stage-restructure-and-lesson-consolidation.md`
- v1(8-Stage 안) — `docs/specs/2026-05-20-lesson-consolidation-and-deepening.md` (SUPERSEDED, 역사 자료)
- 선행 — 여정 필터(`JourneyFilter`)가 main에 도입돼 페르소나 데이터 가시화 완료
